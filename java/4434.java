...
class Rational{
    ...
    public static Rational getFraction(String a){
        String[] arr = a.split("\\.");
        if(arr.length>=2){
            String s ="1";
            ...
            Rational k = new Rational(new BigInteger(arr[0]+arr[1]),new BigInteger(s));
            return k;
        }
        else{
            Rational k = new Rational(new BigInteger(arr[0]),new BigInteger("1"));
            return k;
        }
    }
